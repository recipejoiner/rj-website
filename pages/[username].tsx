...
import { UserInfoType, UserByUsernameVarsType, USER_INFO_BY_USERNAME } from 'requests/auth';
  ...
  return(
    <React.Fragment>
      <Head>
        ...
        />
        {/* OpenGraph tags */}
        <meta key="og:url" property="og:url" content={`${process.env.NEXT_PUBLIC_BASE_URL}/${username}`} />
...
export const getServerSideProps: GetServerSideProps = async ctx => {
  ...
  try {
    ...
    const data: UserInfoType = await client.query({
