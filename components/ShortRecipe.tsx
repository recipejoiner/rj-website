...
import { minutesToTime } from 'helpers/methods'
...
const ShortRecipe: React.FC<ShortRecipeProps> = ({ node }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto font-mono overflow-hidden border-gray-500 border-b">
      <div className="mx-auto p-4 bg-white   ">
        ...
        <div className="grid grid-cols-4 pt-1">
          ...
          <div className="col-span-3 self-end h-full w-full grid grid-rows-2">
            <div className="ml-4 w-full  text-xs">
              <Link href="/[username]" as={`/${username}`}>
                <a className="flex align-middle ">
                  ...
                  <div className="ml-2 self-center grid grid-rows-2">
